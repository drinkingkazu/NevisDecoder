...
#decoder.set_format(fmwk.kASCII)
decoder.set_format(fmwk.kBINARY)
...
#decoder.set_verbosity(larlite.msg.kDEBUG)
#decoder.set_verbosity(larlite.msg.kINFO)
#decoder.set_verbosity(larlite.msg.kNORMAL)
