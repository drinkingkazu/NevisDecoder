...
#ifndef NEVISDECODER_DECODER_MANAGER_H
#define NEVISDECODER_DECODER_MANAGER_H
...
#include "DecoderBase/bin_io_handler.h"
#include "DecoderAlgo/algo_base.h"
...
namespace decoder {
  ...
  /**
    ...
    storage manager. 
   */
  class decoder_manager : public ::larlite::larlite_base {
  ...
  public:
    ...
    void set_format(InputFile_t fmt){_fin.set_format(fmt);};
  ...
  private:
    ...
    */
    ...
    // storage I/O
    ::larlite::storage_manager *_storage;  ///< Output file I/O handler
