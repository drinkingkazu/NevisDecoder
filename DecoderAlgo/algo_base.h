...
#ifndef NEVISDECODER_ALGO_BASE_H
#define NEVISDECODER_ALGO_BASE_H

#include "DataFormat/storage_manager.h"
#include "Base/FEMConstants.h"
#include "DecoderBase/DecoderConstants.h"
#include <sstream>
#include <deque>
...
namespace decoder {
  ...
  */
  class algo_base : public ::larlite::larlite_base {
    
  public:
    
    /// Default constructor 
    algo_base() : larlite_base() { 
      _name="algo_base"; 
      _storage=0; 
      _debug_mode=false; 
      _bt_mode=false;
    ...
    */
    ...
    {if(word) return kUNDEFINED_WORD; else return kUNDEFINED_WORD;};
    ...
    void set_storage_ptr(::larlite::storage_manager* storage){_storage=storage;};
    ...
    {
      print(::larlite::msg::kWARNING,__FUNCTION__,"Dumping a backtrace...");
      int ctr=1;
  ...
  protected:
    ...
    // Data
    // 
    ::larlite::storage_manager* _storage;  ///< Data storage pointer to be provided by a parent process.
