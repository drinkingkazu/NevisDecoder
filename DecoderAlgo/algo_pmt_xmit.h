...
/** \addtogroup Algorithm
    ...
    @{*/
#ifndef NEVISDECODER_ALGO_PMT_XMIT_H
#define NEVISDECODER_ALGO_PMT_XMIT_H
...
namespace decoder {
  ...
  protected:
    ...
    ::larlite::fifo _ch_data;

    ::larlite::event_fifo* _event_data;
